...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_dlist = 18,                     /* dlist  */
  YYSYMBOL_decl = 19,                      /* decl  */
  YYSYMBOL_var = 20,                       /* var  */
  YYSYMBOL_slist = 21,                     /* slist  */
...
{
       0,    43,    43,    46,    47,    48,    51,    54,    62,    63,
      66,    69,    74,    75,    76,    79,    80,    88,    91,    92,
      93,   100
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VAR", "PRINT",
  "ASSIGN", "NUMBER", "ID", "'+'", "'-'", "'*'", "'/'", "UMINUS", "';'",
  "'('", "')'", "$accept", "prog", "dlist", "decl", "var", "slist", "stmt",
...
{
       9,    -6,     5,    14,     6,    -7,    -7,    -7,    -3,    12,
      11,    17,    -7,    -7,    -7,    -3,    -3,    -7,    15,    16,
      -7,    -7,    -3,     3,    -7,     0,    -3,    -3,    -3,    -3,
      15,    -7,    -7,    16,    16,    -7,    -7
};
...
{
       5,     0,     0,     0,     0,     7,     6,     1,     0,     0,
       0,     2,     8,     3,    21,     0,     0,    20,    11,    14,
      17,     4,     0,     0,    19,     0,     0,     0,     0,     0,
      10,     9,    18,    12,    13,    15,    16
};
...
{
      -7,    -7,    -7,    28,    -1,    -7,    13,    -2,     2,     4
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     2,     3,     4,    17,    11,    12,    18,    19,    20
};
...
{
       6,     5,    10,    14,     5,     7,    15,     8,    26,    27,
       5,    16,     1,    24,    25,    32,    22,     1,     8,    13,
      30,     5,    10,    26,    27,    21,    28,    29,    33,    34,
      23,     9,    35,    36,     0,     0,    31
};
...
{
       1,     7,     3,     6,     7,     0,     9,     4,     8,     9,
       7,    14,     3,    15,    16,    15,     5,     3,     4,    13,
      22,     7,    23,     8,     9,    13,    10,    11,    26,    27,
      13,     3,    28,    29,    -1,    -1,    23
};
...
{
       0,     3,    17,    18,    19,     7,    20,     0,     4,    19,
      20,    21,    22,    13,     6,     9,    14,    20,    23,    24,
      25,    13,     5,    13,    23,    23,     8,     9,    10,    11,
      23,    22,    15,    24,    24,    25,    25
};

/* YYR1[RULE-NUM] -- Symbol kind of the left-hand side of rule RULE-NUM.  */
static const yytype_int8 yyr1[] =
{
       0,    16,    17,    18,    18,    18,    19,    20,    21,    21,
...
#line 54 "calc.y"
        {
        struct symbol *s = sym_lookup((yyvsp[0].id));
        if(s == NULL)
            s = sym_add((yyvsp[0].id));
        (yyval.sym) = s;
    }
#line 1116 "calc.tab.c"
    break;

  case 10: /* stmt: var ASSIGN expr  */
#line 66 "calc.y"
                      {
        (yyvsp[-2].sym)->value = (yyvsp[0].number);
    }
...
#line 93 "calc.y"
          {
        struct symbol *s = sym_lookup((yyvsp[0].sym)->name);
        if(s == NULL)
            yyerror("undefined variable");
        else
            (yyval.number) = s->value;
    }
