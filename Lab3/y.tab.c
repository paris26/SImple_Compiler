...
{
  "\"end of file\"", "error", "\"invalid token\"", "REAL", "PLUS",
  "MINUS", "TIMES", "DIVIDE", "POWER", "LEFT", "RIGHT", "END", "$accept",
...
{
      -7,    10,    -7,    -7,     9,     9,    16,    29,    24,     9,
       9,     9,     9,     9,    -7,    -7,    29,    29,    -6,    -6,
      -6
};
...
{
       2,     0,     1,     4,     0,     0,     0,    11,     0,     0,
       0,     0,     0,     0,     3,    10,     5,     6,     7,     8,
       9
};
...
{
       7,     8,    13,     0,     0,    16,    17,    18,    19,    20,
       2,     0,     3,     3,     4,     4,     0,     0,     5,     5,
       9,    10,    11,    12,    13,     0,     0,    14,     9,    10,
      11,    12,    13,     0,    15,    11,    12,    13
};

static const yytype_int8 yycheck[] =
{
       4,     5,     8,    -1,    -1,     9,    10,    11,    12,    13,
       0,    -1,     3,     3,     5,     5,    -1,    -1,     9,     9,
...
{
       0,    13,     0,     3,     5,     9,    14,    14,    14,     4,
       5,     6,     7,     8,    11,    10,    14,    14,    14,    14,
      14
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* program: program expression END  */
#line 19 "calc.y"
                              { printf("Result: %g\n", yyvsp[-1]); }
#line 1145 "y.tab.c"
    break;

  case 4: /* expression: REAL  */
#line 23 "calc.y"
                            { yyval = yyvsp[0]; }
#line 1151 "y.tab.c"
    break;
...
#line 1175 "y.tab.c"
  ...
  case 9: /* expression: expression POWER expression  */
#line 28 "calc.y"
                                   { yyval = pow(yyvsp[-2], yyvsp[0]); }
#line 1181 "y.tab.c"
    break;

  case 10: /* expression: LEFT expression RIGHT  */
#line 29 "calc.y"
                                  { yyval = yyvsp[-1]; }
#line 1187 "y.tab.c"
    break;

  case 11: /* expression: MINUS expression  */
#line 30 "calc.y"
                                 { yyval = -yyvsp[0]; }
#line 1193 "y.tab.c"
    break;
